...
#PBS -l select=1:ncpus=1:mem=1gb:scratch_local=10gb
#PBS -m abe
#PBS -j oe
...
Rscript --vanilla runDMC.R --pops `echo $pops` --sampleSizes "32,32,16,16" --times_sv "5e3,1e4,5e4,1e5" --times_sv_source "100,1e3,5e3,1e4" --times_stagSweeps "0,50,500,1e3,1e4"
